...
/radar/contributions/      Public static contribution history generated into docs/radar/contributions/index.html
/radar/admin/              Protected Worker-rendered admin console
```

The public dashboard includes **Contributions** and **Admin Console** links in the header. That link is generated by `scripts/generate-dashboard.py` and points to `/radar/admin/`.
...
The public dashboard is served at `/radar/` through Cloudflare Pages/Worker routing. The public contribution history page is served at `/radar/contributions/`.
