...
Generated: 2026-06-17 03:41

## Summary

- Datasets discovered: 20
...
| Top Opportunities | 256 | Remaining unreviewed tickets ranked by score. |
| Shortlisted | 0 | Tickets manually marked as strong candidates. |
| Watching | 4 | Tickets worth monitoring but not acting on yet. |
| Completed / Acted On | 8 | Tickets already tested, commented on, propped, or committed. |
...
#### 2. [#65419](https://core.trac.wordpress.org/ticket/65419) — In the Add Themes and Plugins page, active tabs are not visible in Windows High Contrast Mode
...
#### 7. [#65048](https://core.trac.wordpress.org/ticket/65048) — wp_ajax_fetch_list(): Sanitize $_GET input before nonce construction
...
#### 10. [#54016](https://core.trac.wordpress.org/ticket/54016) — Media Library: Bulk delete elements in grid view takes very long
...
#### 11. [#58416](https://core.trac.wordpress.org/ticket/58416) — Media Title field should soft wrap in Media Modal: For better readability/editing of long titles.
...
#### 12. [#60029](https://core.trac.wordpress.org/ticket/60029) — Admin unable to create new Application Password for user with no role on main site (multisite)
...
- Why it ranked: track priority: General: Needs Testing +65, has patch +35, needs testing +30, has concrete milestone +8, has owner +6, freshness: recently updated <=14 days +20, setup complexity: multisite environment -14
- Score breakdown:
  - +65: Track Priority
  - +35: Has Patch
  - +30: Needs Testing
...
#### 13. [#65281](https://core.trac.wordpress.org/ticket/65281) — Custom Time & Date Format Fields Allow Empty Save Instead of Validation
...
#### 30. [#64863](https://core.trac.wordpress.org/ticket/64863) — Eliminate switch_to_blog() from get_blog_option(), update_blog_option(), WP_Site::get_details(), and get_blog_post() using $wpdb->get_blog_prefix()
...
#### 31. [#64991](https://core.trac.wordpress.org/ticket/64991) — New param "allow_multiple_terms" in `register_taxonomy` for single term restriction
...
- Modified: 04/24/2026 06:12:03 PM
- Why it ranked: track priority: General: Needs Testing +65, has patch +35, needs testing +30, freshness: updated within 60 days +10, ticket age: mature but not ancient +8
- Score breakdown:
  - +65: Track Priority
  - +35: Has Patch
...
#### 48. [#19173](https://core.trac.wordpress.org/ticket/19173) — Issues with wp_editor() when used inside of a meta box.
...
#### 49. [#22367](https://core.trac.wordpress.org/ticket/22367) — Usernames with "@" char are assumed email addresses, causing incorrect look-up in several places
...
#### 50. [#26571](https://core.trac.wordpress.org/ticket/26571) — Increase flexibility of "At a Glance" Dashboard Widget to match "Right Now" Widget
...
#### 3. [#65392](https://core.trac.wordpress.org/ticket/65392) — "Show more comments" button in comments metabox doesn't load new comments if they are of a type different than 'comment'
...
- Why it ranked: track priority: General: Needs Testing +65, has patch +35, needs testing +30, dev feedback +18, freshness: recently updated <=14 days +20, setup complexity: custom content type setup -12
- Score breakdown:
  - +65: Track Priority
  - +35: Has Patch
  - +30: Needs Testing
...
#### 5. [#41081](https://core.trac.wordpress.org/ticket/41081) — Improve Custom Menu widget, show notification if menu is empty or no menu selected
...
- Why it ranked: track priority: General: Needs Testing +65, has patch +35, needs testing +30, preferred component: Media +20, has concrete milestone +8, freshness: recently updated <=14 days +20, already tested -20
- Score breakdown:
  - +65: Track Priority
  - +35: Has Patch
  - +30: Needs Testing
...
|---|---:|---:|---|
| accessibility_has_patch | 2026-06-13 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-13/accessibility_has_patch.csv` |
| docs_needs_testing | 2026-06-13 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-13/docs_needs_testing.csv` |
| general_needs_testing | 2026-06-13 | 256 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-13/general_needs_testing.csv` |
| good_first_bugs | 2026-06-13 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-13/good_first_bugs.csv` |
| media_has_patch | 2026-06-13 | 24 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-13/media_has_patch.csv` |
| accessibility_has_patch | 2026-06-14 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-14/accessibility_has_patch.csv` |
| docs_needs_testing | 2026-06-14 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-14/docs_needs_testing.csv` |
| general_needs_testing | 2026-06-14 | 256 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-14/general_needs_testing.csv` |
| good_first_bugs | 2026-06-14 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-14/good_first_bugs.csv` |
| media_has_patch | 2026-06-14 | 24 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-14/media_has_patch.csv` |
| accessibility_has_patch | 2026-06-15 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-15/accessibility_has_patch.csv` |
| docs_needs_testing | 2026-06-15 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-15/docs_needs_testing.csv` |
| general_needs_testing | 2026-06-15 | 255 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-15/general_needs_testing.csv` |
| good_first_bugs | 2026-06-15 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-15/good_first_bugs.csv` |
| media_has_patch | 2026-06-15 | 24 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-15/media_has_patch.csv` |
| accessibility_has_patch | 2026-06-16 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-16/accessibility_has_patch.csv` |
| docs_needs_testing | 2026-06-16 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-16/docs_needs_testing.csv` |
| general_needs_testing | 2026-06-16 | 254 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-16/general_needs_testing.csv` |
| good_first_bugs | 2026-06-16 | 0 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-16/good_first_bugs.csv` |
| media_has_patch | 2026-06-16 | 24 | `/mnt/data/radar31/wp-core-radar-main/data/raw/manual/2026-06-16/media_has_patch.csv` |
